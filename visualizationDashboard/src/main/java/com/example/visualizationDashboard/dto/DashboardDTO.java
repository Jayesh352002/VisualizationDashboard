package com.example.visualizationDashboard.dto;
...
public class DashboardDTO {
	...
	public DashboardDTO(int id, long end_year, String citylng, String citylat, int intensity, String sector,
	...
	public DashboardDTO(long end_year, String citylng, String citylat, int intensity, String sector, String topic,
	...
	public String toString() {
		return "DashboardDTO [id=" + id + ", end_year=" + end_year + ", citylng=" + citylng + ", citylat=" + citylat
